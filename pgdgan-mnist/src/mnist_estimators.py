...
def gan_estimator(hparams):
    ...
    z_batch = tf.Variable(tf.random_normal([hparams.batch_size, 20]), name='z_batch')
    x_hat_batch, restore_dict_gen, restore_path_gen = mnist_model_def.gan_gen(z_batch, hparams)

    # Create the discriminator
    prob, restore_dict_discrim, restore_path_discrim = mnist_model_def.gan_discrim(x_hat_batch, hparams)
