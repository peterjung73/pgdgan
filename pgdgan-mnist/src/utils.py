...
def get_estimator(hparams, model_type):
    ...
    if model_type == 'gan':
        estimator = mnist_estimators.gan_estimator(hparams)
    else:
...
def get_matrix_save_path(hparams):
    ...
    save_path = './estimated/mnist/{0}/{1}/matrix_{2}.png'.format(
        hparams.input_type,
        hparams.measurement_type,
        #hparams.num-outer-measurements,
