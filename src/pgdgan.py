...
def main(hparams):
    ...
    if hparams.save_array:
        utils.save_results('./1', np.matmul(x_hat, A_outer), x_hat, y, x)
...
if __name__ == '__main__':
    ...
    PARSER.add_argument('--save-array', action='store_true', help='whether to save the numpy arrays')
    ...
    os.chdir('/Users/damara/PycharmProjects/pgdgan')
